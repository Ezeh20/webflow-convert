  ...
  <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease"
    ...
    <div data-node-type="commerce-cart-wrapper" data-open-product="" data-wf-cart-type="rightSidebar"
      ...
      <a href="#" data-node-type="commerce-cart-open-link"
        ...
        aria-label="Open cart"><img :src="cart" alt="">
        ...
        <div data-node-type="commerce-cart-container" role="dialog"
          ...
          <div class="w-commerce-commercecartformwrapper">
            <form data-node-type="commerce-cart-form" style="display:none" class="w-commerce-commercecartform">
              <!-- <script type="text/x-wf-template" id="wf-template-c451091d-f7cf-9fb7-0eeb-cad6d340c589"></script> -->
              <div class="w-commerce-commercecartlist cart-list" data-wf-collection="database.commerceOrder.userItems"
                data-wf-template-id="wf-template-c451091d-f7cf-9fb7-0eeb-cad6d340c589"></div>
              <div class="w-commerce-commercecartfooter cart-footer">
                ...
                <div>
                  ...
                  <a href="checkout.html" value="Continue to Checkout" data-node-type="cart-checkout-button"
                    class="w-commerce-commercecartcheckoutbutton button checkoutbutton"
    ...
    <div @click="toggleMenu" :class="{ 'w--open': isMenuOpen }" class="menu-button w-nav-button"
      ...
      aria-haspopup="menu" aria-expanded="false"><img
        ...
        alt=""></div>
    <div class="w-nav-overlay hide-navv" data-wf-ignore="" id="w-nav-overlay-0"
      :style="{ display: isMenuOpen ? 'block' : 'none', height: '2187.59px' }">
      <nav role="navigation" class="nav-menu w-nav-menu"
